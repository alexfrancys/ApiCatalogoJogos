using ApiCatalogoJogosAlex.Entities;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Threading.Tasks;

namespace ApiCatalogoJogosAlex.Repositories
{
    public class JogoRepository : IJogoRepository
    {
        ...
        public Task<List<Jogo>> Obter(string nome, string produtora) //Usando linq / Expressão Lambda
        {
